        ...
        <main class="main--container">
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="page--title h5">Events/Organizors</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="ecommerce.html">Events</a></li>
                                <li class="breadcrumb-item "><span></span>Events/Organizors</li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="summary--widget">
                ...
                <div class="panel">
                    <div class="records--header">
                        <div class="title fa-shopping-bag">
                            <h3 class="h3"> Events by Organizors <a href="#" class="btn btn-sm btn-outline-info">Events with it's organizors</a></h3>
                            <p>Events listing with it's organizors</p>
                        </div>
                        <div class="actions">
                            <form   class="search flex-wrap flex-md-nowrap"> <input type="text" class="form-control"  id="myInput" onkeyup="quickFind()" placeholder="search for events.." title="search for events by name" name="search"   required> <button  class="btn btn-rounded"><i class="fa fa-search"></i></button> </form> </div>
                    </div>
                </div>
                <?PHP
...
$listeorganiz=$organizc->joinOrganizs();
