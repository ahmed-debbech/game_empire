                            ...
                            <ul>
                                ...
                                <li class="">
                                    ...
                                    <ul>
                                        ...
                                        <li class=""><a href="collab2-add.html">Add Event</a></li>
...
if (isset($_POST['id_org'])){
    ...
    $result=$organizc->backupOrganiz($_POST['id_org']);
...
?>
                                    ...
                                    <div> <input type="hidden" name="id_org_ini" value="<?PHP echo $_GET['id_org'];?>"> </div>
                                        ...
                                        <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Full name: *</span>
                                            <div class="col-md-9"> <input type="text" name="text" value="<?PHP echo $name ?>"class="form-control" required> </div>
                                        </div>
                                        <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Email: *</span>
                                            <div class="col-md-9"> <input type="text" name="text" value="<?PHP echo $email ?>" class="form-control" required> </div>
                                        </div>
                                        <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Phone: *</span>
                                            <div class="col-md-9"> <input type="text" name="text" value="<?PHP echo $phone ?>"class="form-control" required> </div>
                                        </div>
