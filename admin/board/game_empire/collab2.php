...
/*function image($id){
    $query = "SELECT name FROM imagee where id_event='$id'";  
...
<table class="table" style="background-color: white;" id="myTable1" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" ></th>
                                               <th> <a name="order2"  href="collab2-ord.php" title="ascendant name order"class="btn btn-rounded btn-outline-warning">Order</a>
...
foreach($listeevent as $row){
    ...
    <td><form method="POST" action="collab2-edit.php">
