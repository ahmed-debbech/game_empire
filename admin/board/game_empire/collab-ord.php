                        ...
                        <ul>
                            ...
                            <a href="#"> <i class="collab"></i> <span>Associates</span> </a>
                                ...
                                <li class="active"><a href="collab.php">Organizors</a></li>
                                        <li><a href="collab-add.html">Add Organizor</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="ecommerce.html">Associates</a></li>
...
$listeorganiz=$organizc->sortOrganizs();
                                    ...
                                    <table class="table" style="background-color: white;" id="myTable" >
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" ></th>
                                                <th>  
                                                <a name="order" title="ascendant name order" href="collab.php" class="btn btn-rounded btn-outline-warning">order</a>
                                                <a name="join" title="join organizors and their events" href=""  class="btn btn-rounded btn-outline-primary">ORGAN|EVent</a>
                                                </th>
...
foreach($listeorganiz as $row){
    ...
    <td><form method="POST" action="collab-edit.php?id_org=<?PHP echo $row['id_org']; ?>"> 
    <div class="col mb-3"> <button  class="btn btn-rounded btn-outline-info"name="Edit"  >✒️</button> </div>
	
	<input type="hidden" value="<?PHP echo $row['id_org']; ?>" name="id_org">
	</form>
    <td><form method="POST" action="core/deleteOrganiz.php" >
    <div class="col mb-3"> <button class="btn btn-rounded btn-outline-danger"name="Delete">❌</button> </div>
