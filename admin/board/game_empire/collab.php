                                    ...
                                    <table class="table" style="background-color: white;" id="myTable" >
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" ></th>
                                                <th>  
                                                <a name="order"  href="collab-ord.php" title="ascendant name order"class="btn btn-rounded btn-outline-warning">Order</a>
