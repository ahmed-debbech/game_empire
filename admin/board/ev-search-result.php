                        ...
                        <ul>
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="page-light.html">Page Light</a></li>
        ...
        <main class="main--container">
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="page--title h5">Search</h2>
...
$listeevent=$eventc->searchEvent($id_event);


?>
 <h5 class="tittre">Event</h5>
                <table class="table" >
                                        <thead>
                                            <tr>
                                                
                                                <th scope="col" >ID</th>
                                                <th scope="col" >Organizator ID</th>
