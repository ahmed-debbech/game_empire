            ...
            <section class="main--content">
                <div class="panel">
                    <div class="records--header">
                        ...
                        <div class="actions">
                            <form action="#" class="search flex-wrap flex-md-nowrap"> <input type="text" name="scoop" class="form-control" placeholder="search event..." required> <button type="submit" class="btn btn-rounded"><i class="fa fa-search"></i></button> </form> <a href="collab2-add.html" class="addProduct btn btn-lg btn-rounded btn-warning">Add Event</a>                            </div>
                    </div>
                </div>
                <?PHP
...
foreach($listeevent as $row){
	...
	<div class="col mb-3"> <button class="btn btn-outline-info"name="Edit2">Edit</button> </div>
	<input type="hidden" value="<?PHP echo $row['id_event']; ?>" name="id_event">
	</form>
	<td><form method="POST" action="core/deleteEv.php">
	<div class="col mb-3"> <button class="btn btn-outline-danger"name="Delete2">Delete</button> </div>
	<input type="hidden" value="<?PHP echo $row['id_event']; ?>" name="id_event">
	</form>
