...
<div class="nk-gap-1">
 ...
 <!-- START: Image Slider -->
  <div class="main_carousel" >
                   ...
                   <div class="cell"><img height="500px" src="admin/affiches/ev1.jpg"> </div>
                   ...
                   <div class="cell"><img src="admin/affiches/ev9.jpg"> </div>
                    ...
                    else
                    {
                        ...
                        foreach($liste as $row){
                            ...
                            ?>
                                ...
                                <div class="nk-gap-1"><?PHP echo $row['date_start']; ?></div>
                                <div class="nk-gap-1"><?PHP echo $row['date_end']; ?></div>
                                <div class="nk-gap-1"><?PHP echo $row['location']; ?></div>
