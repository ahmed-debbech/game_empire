        ...
        <div class="col-lg-8">
            <div class="nk-store-product">
                <div class="row vertical-gap">
                    ...
                    ?>
                         <h3 class="nk-product-title h6" style="color:turquoise;"><a><?PHP echo $row['typee']; ?></a></h3> 
                         <h3 class="nk-product-title h6" style="color:crimson;"><a><?PHP echo $row['status'];?></a></h3>
                        <div class="nk-product-description">Start date : <?PHP echo $row['date_start'];?></div>
                        <div class="nk-product-description">End date   : <?PHP echo $row['date_end']; ?></div>
                        <div class="nk-product-description">Location :    <?PHP echo $row['location']; ?></div>
