                        ...
                        <ul>
                            ...
                            <a href="#"> <i class="collab"></i> <span>Associates</span> </a>
                                ...
                                <li class="active"><a href="collab.php">Organizors</a></li>
                                        ...
                                        <li><a href="collab-edit.html">Edit Organizor</a></li>
                            ...
                            <a href="#"> <i class="collab"></i> <span>Events</span> </a>
                                ...
                                <li class=""><a href="collab2.php">Events</a></li>
                                        ...
                                        <li><a href="collab2-edit.html">Edit Event</a></li>
            ...
            <section class="main--content">
                <div class="panel">
                    <div class="records--header">
                        ...
                        <div class="actions">
                            <form action="#" class="search flex-wrap flex-md-nowrap"> <input type="text" class="form-control" placeholder="Organizor Name..." required> <button type="submit" class="btn btn-rounded"><i class="fa fa-search"></i></button> </form> <a href="collab-add.html" class="addProduct btn btn-lg btn-rounded btn-warning">Add Organizor</a>                            </div>
                    </div>
                </div>
                <?PHP
                ...
                <table class="table" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" >Edit Organizor</th>
                                                <th scope="col" >Delete Organizor</th>
                                                </th>
...
foreach($listeorganiz as $row){
    ...
    <div class="col mb-3"> <button class="btn btn-outline-info"name="Edit">Edit</button> </div>
	
	<input type="hidden" value="<?PHP echo $row['id_org']; ?>" name="id_org">
	</form>
    <td><form method="POST" action="core/deleteOrganiz.php">
    <div class="col mb-3"> <button class="btn btn-outline-danger"name="Delete">Delete</button> </div>
