...
if (isset($_GET['id_plat'])){
    ...
    $result=$platformC->recupererplatform($_GET['id_plat']);
...
<tr>
<td>Id Platform</td>
<td><input type="text" name="id_plat" value="<?PHP echo $id_plat ?>"></td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="id_plat_ini" value="<?PHP echo $_GET['id_plat'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
    $platform=new platform($_POST['name'],$_POST['id_plat']);
    $platformC->modifierplatform($platform,$_POST['id_plat_ini']);
    
    //echo $_POST['id_plat_ini'];
