...
-->
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/karousel.css">
...
-->
    ...
    <body>
        ...
        {$add=$_GET['add'];
         if($add==1)
        echo '<script type="text/javascript">swal("Welcome!", "Your Account Has Been Registered!", "success");</script>';  
        ...
        <div class="nk-main">
            ...
            <div class="container">
                ...
                <div class="main_carousel" >
                   <div class="cell"><img height="720px" weight="1280px" src="admin/pictures/e1.jpg"></div>
                   <div class="cell"><img src="admin/pictures/e2.jpg" ></div>
                   <div class="cell"><img src="admin/pictures/e3.jpg"></div>
                   <div class="cell"><img src="admin/pictures/e4.jpg"></div>
                   <div class="cell"><img src="admin/pictures/e5.jpg"></div>
                ...
                <div class="row vertical-gap">
                    ...
                    foreach($liste2 as $row){
				        ...
				        $sql5="select * From game order by score  desc limit 4 ";
