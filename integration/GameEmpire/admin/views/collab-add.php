...
<head>
    ...
    <title>GAME EMPIRE - Add Organizor</title>
                        ...
                        <ul>
                            ...
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="collab-add.php">Add Organizor</a></li>
        ...
        <main class="main--container">
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="page--title h5">Add Organizor</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="collab.php">Associates</a></li>
                                <li class="breadcrumb-item active"><span>Add Organizor</span></li>
                ...
                <div class="panel">
                    <div class="records--header">
                        <div class="title fa-shopping-bag">
                            <h3 class="h3">Organizors <a href="#" class="btn btn-sm btn-outline-info">Add Organizor Infos</a></h3>
