...
<!-- Mirrored from html.nkdev.info/goodgames/offline.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Apr 2020 00:35:30 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <title>GoodGames | change reports</title>
...
<div class="nk-fullscreen-block">
    <div class="nk-fullscreen-block-top">
        <div class="text-center">
            ...
            <a href="index.html"><img src="assets/images/logo.svg" alt="GoodGames"></a>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                    <h1 class="h2"><span class="text-main-1">Change </span> Report</h1>

                    <div class="text-white">Here you can change your reports for a better problem description </div>
                    <div class="nk-gap-2"></div>
