          ...
          <li class="nav-item dropdown">
           ...
           <h6>  <?php
              ...
              <a style ="
                         ...
                         ?>
                         " class="dropdown-item" href="view1.php?id_notif=<?php echo $i['id_notif'] ?>">
                <h6><small><i><?php echo date('F j, Y, g:i a',strtotime($i['date'])) ?></i></small></h6><br/>
                <h6> <?php 
                  
                if($i['type']=='comment'){
                    echo ucfirst($i['username'])." commented on your post."; 
                }else if($i['type']=='like'){
...
<div class="container">
    ...
    <!-- START: Categories -->
 <?PHP  
 include_once 'core/platformPC.php';
        ...
        <div class="col-lg-12">
            <div class="nk-feature-1">
                ...
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a><?PHP echo $row['name']; ?></a></h3>
