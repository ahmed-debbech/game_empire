            ...
            <section class="main--content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Supprimer Platform</h5>
                          <form method="post" action="supprimerplatform.php">
                                    <table align="center">
                                        <tbody><tr>
                                            <td>ID Platform  </td>
                                            <td>
                                                <input type="nummber" name="id_plat">
                                            </td>
                                            <td > <div class="col mb-6"> <button class="btn btn-rounded btn-danger">Supprimer</button> </div></td>
                                        </tr>
                                    </tbody></table>
