...
<head>
    ...
    <title>GAME EMPIRE - Add Event</title>
                        ...
                        <ul>
                            ...
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="collab2-add.php">Add Event</a></li>
        ...
        <main class="main--container">
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="page--title h5">Add Event</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="collab2.php">Events</a></li>
                                <li class="breadcrumb-item active"><span>Add Event</span></li>
                ...
                <div class="panel">
                    <div class="records--header">
                        <div class="title fa-shopping-bag">
                            <h3 class="h3">Events <a href="#" class="btn btn-sm btn-outline-info">Add Event Infos</a></h3>
                    ...
                    <div class="records--body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab01">
                                <form name="formular2" id="formular2" method="post" action="../core/addEv.php" onsubmit="return checkCap2();">
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">ID: *</span>
                                        <div class="col-md-9"> <input type="number" placeholder="Event's ID" name="id_event" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Organizor ID: *</span>
                                        <div class="col-md-9"> <input type="number" name="id_org" placeholder="Organizor's ID" class="form-control" required> </div>
                                    </div>

                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Name: *</span>
                                        <div class="col-md-9"> <input type="text" placeholder="Event's Name" name="namee" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Image: *</span>
                                        <div class="col-md-9"> <label class="custom-file"> <input type="file" name="pic" class="custom-file-input" required> <span class="custom-file-label">Choose an Image</span> </label> </div>
                                    </div>
                                    ...
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Start date: *</span>
                                        <div class="col-md-9"> <input type="date" name="date_start" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">End date: *</span>
                                        <div class="col-md-9"> <input type="date" name="date_end" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Location: *</span>
                                        <div class="col-md-9"> <input type="text" name="location" placeholder="Event's location here.." class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Description: *</span>
                                        <div class="col-md-9"> <input type="text" name="detail" placeholder="Description of the event here.." class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Video: *</span>
                                        <div class="col-md-9"> <input type="text" name="video" placeholder="Set video's URL <Embed> Address here.." class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Website: *</span>
                                        <div class="col-md-9"> <input type="text" name="site" placeholder="website address here.." class="form-control" required> </div>
                                    </div>

                                    <div class="row mt-3">
                                        <div class="col-md-9 offset-md-3"> <input type="submit" name="add2" id="add2" value="➕" class="btn btn-rounded btn-success"> </div>
                                    </div>
                                </form>
                            </div>
