                        ...
                        <ul>
                            ...
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="products-add.php">Add Products</a></li>
                            ...
                            <div class="tab-pane fade show active" id="tab01">
                                <form method="post" action="addGame.php" enctype="multipart/form-data">
                                	<div class="form-group row"> <span class="label-text col-md-3 col-form-label">Game ID: *</span>
                                        <div class="col-md-9">
                                            <input type="number" name="id_game" min="0" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Game Name: *</span>
                                        <div class="col-md-9">
                                            <input type="text" pattern="[a-zA-Z0-9- ]+" maxlength="30" name="name" class="form-control" required> </div>
                                    </div>

                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Release date	: *</span>
                                        <div class="col-md-9">
                                            <input type="date" min="2000-01-01" max="2023-12-31" name="release_date" class="form-control" required> </div>
                                    </div>
                                    ...
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Price: *</span>
                                        <div class="col-md-9">
                                            <input type="number" name="price" max="120" min="0" class="form-control" required> </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Solde: *</span>
                                        <div class="col-md-9">
                                            <input type="number" name="solde" max="120" min="0" class="form-control" > </div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Score: *</span>
                                        <div class="col-md-9">
                                            <input type="number" name="score" min="0" max="5" class="form-control" required></div>
                                    </div>
                                    <div class="form-group row"> <span class="label-text col-md-3 col-form-label">Trailer: *</span>
                                        <div class="col-md-9">
                                            <input type="url" name="trailer" class="form-control" required> </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-9 offset-md-3">
                                            <input type="submit" value="Add Game" name="addGame" class="btn btn-rounded btn-success"> </div>
                                    </div>
                                </form>
                            </div>
