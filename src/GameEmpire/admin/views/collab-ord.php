                                    ...
                                    <table class="table" style="background-color: white;" id="myTable" >
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>  
                                                <a name="order" title="default table order" href="collab.php" class="btn btn-rounded btn-outline-warning">default</a>
                                                <a name="join" title="join organizors and their events" href="joiner.php"  class="btn btn-rounded btn-outline-primary">ORGAN|EVent</a>
                                                </th>
...
foreach($listeorganiz as $row){
    ...
    <td style="color:DarkSlateGray;"><img src="../pics/<?PHP echo $row['img'] ?>" width="100" height="40"> </td>
