...
<!-- Mirrored from themelooks.net/demo/dadmin/html/order-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Apr 2020 19:11:45 GMT -->
            ...
            <div class="navbar--nav ml-auto">
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown nav--user online">
                        <a href="#" class="nav-link" data-toggle="dropdown">
                            <img src="assets/img/avatars/01_80x80.png" alt="" class="rounded-circle"> <span><?php echo $order_id; ?></span> <i class="fa fa-angle-down"></i> </a>
                        <ul class="dropdown-menu">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><span>Order View</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="summary--widget">
                ...
                <div class="panel">
                    <div class="records--header">
                        <div class="title fa-shopping-bag">
                            <h3 class="h3">Ecommerce Order View <a href="orders.php" class="btn btn-sm btn-outline-info">View
                                    Orders List</a></h3>
                        </div>
                    </div>
                </div>
                <div class="panel">
                    <div class="records--body">
                        <div class="title">
                            ...
                            {
                                echo'<h6 class="h6">Order #'.$row2['order_id'].'<span class="text-lightergray"> - '.$row2['created_date'].'</span>
                                </h6>
                                <div>&nbsp;&nbsp;<a href="../../receipt_copy.php?act=overview&id='.$row2['order_id'].'" class="btn btn-sm btn-outline-danger">View
                                invoice</a></div>';
                            }?>
...
foreach($list as $rowc){
    foreach($list1 as $row) 
    {
                                                ...
                                                <table class="table table-simple">
                                                    <tbody><tr>
                                                    <td>Customer Name:</td>
                                                    <th><a href="#" class="btn-link">'.$row['first_name'].' '.$row['last_name'].'</a></th>
                                                </tr>
                                                <tr>
                                                    <td>Order Number:</td>
                                                    <th>#'.$row['order_id'].'</th>
                                                ...
                                                <tr>
                                                    <td>Item Numbers:</td>
                                                    <th>'.$row['order_quantity'].'</th>
                                                </tr>
                                                <tr>
                                                    <td>Client History:</td>
                                                    <th>'.$rowcount.' Past Orders</th>
                                                </tr>
                                                <tr>
                                                <td>Order Status:</td>';
                                                if ($rowc['status'] == 'Pending')
                                                {
                                                    echo '<th> <span class="label label-info">Pending</span> </th>';
                                                }
                                                else if($rowc['status'] == 'Approved')
                                                {
                                                    echo '<th> <span class="label label-success">Approved</span> </th>';
                                                }
                                                else
                                                {
                                                    echo'<th> <span class="label label-danger">Declined</span> </th>';
                                                }
                                            echo'</tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-simple">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Destination:</td>
                                                    <th>'.$row['address'].', '.$row['town'].', '.$row['state'].'</th>
                                                </tr>
                                                <tr>
                                                    <td>Delivery Date:</td>
                                                    <th>'.$rowc['modified_date'].'</th>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-simple">
                                            <tbody>
                                                <tr>
                                                    <td>Customer Name:</td>
                                                    <th><a href="#" class="btn-link">Justin Adams</a></th>
                                                </tr>
                                                <tr>
                                                    <td>Order Number:</td>
                                                    <th>1231234123</th>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-simple">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Destination:</td>
                                                    <th>#24 Park Avenue Str., New York</th>
                                                </tr>
                                                <tr>
                                                    <td>Delivery Date:</td>
                                                    <th>June 16, 2017</th>
