...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/jsSocials/font-awesome.css" />
    <link rel="stylesheet" type="text/css" href="assets/jsSocials/jssocials.css" />
    <link rel="stylesheet" type="text/css" href="assets/jsSocials/jssocials-theme-plain.css" />


    <!-- FontAwesome -->
    <script defer src="assets/vendor/fontawesome-free/js/all.js"></script>
    <script defer src="assets/vendor/fontawesome-free/js/v4-shims.js"></script>
    <script src="assets/jsSocials/jquery.js"></script>
...
-->
    ...
    <div class="nk-main">
        <?PHP
                            //include "config.php";
                            $id5=$_GET['id_event'];
                            $sql="select * From event where id_event='$id5'";
...
<div class="container">
    <ul class="nk-breadcrumbs">
        ...
        <li><?PHP echo $row['typee']; ?></li>
        
        
        
        
        <li><span><?PHP echo $row['typee']; ?> </span></li>
...
<div class="container">
        ...
        <div class="col-lg-8">
            <div class="nk-store-product">
                <div class="row vertical-gap">
                    ...
                    <div class="col-md-6">
                        <form method="get" >
                    <h2 class="nk-product-title h3"><?PHP echo $row['namee']; ?>  </h2>
                    <?PHP
                    ...
                    ?>
                         ...
                         ?></a></h3>
                        <div class="nk-product-description"> <?PHP echo'<span class="fa fa-calendar-check-o"></span> '.$row['date_start'];''; ?></div>
                        <div class="nk-product-description"><?PHP echo'<span class="fa fa-calendar-times-o"></span> '.$row['date_end'];''; ?></div>
                        <div class="nk-product-description"><?PHP echo'<span class="fa fa-map-marker"></span> '.$row['location'];''; ?></div>
            ...
            <h4 class="nk-decorated-h-2" style="color:crimson;" ><span>Share</span></h4>
            ...
            <!-- START: Share -->
                ...
                <script src="assets/jsSocials/jquery.js"></script>
                 <script src="assets/jsSocials/jssocials.min.js"></script>
                  <script type= "text/javascript">
                        ...
                        $(function() {
                             var linkurl ='<?PHP echo $row['site'];?>';
                              $("#share").jsSocials({
                                  url : linkurl,
                                  text : "check this amazing event !!",
                                  showLabel : false,
                                  showCount : "inside",
                                  shareIn : "popup",
                                  shares: ["facebook","twitter" , "linkedin", "pinterest", "stumbleupon", "whatsapp"]
                                });
                ...
                <div class="nk-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#tab-about" role="tab" data-toggle="tab">Description</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#tab-description" role="tab" data-toggle="tab">Video</a>
                        </li>
                    ...
                    <!-- START: Tab Description -->
                        <div role="tabpanel" class="tab-pane fade show active" id="tab-about">
                            <div class="nk-gap"></div>
                            
                            <h3 class="nk-product-title h5"><a><?PHP echo $row['namee'];?></a></h3>                                                                                   
                            <?PHP echo $row['detail'];?>
                        ...
                        <div role="tabpanel" class="tab-pane fade show active" id="tab-description">
                            <div class="nk-gap"></div>
                            <iframe width="760" height="450" src="<?PHP echo $row['video']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <h3 class="nk-decorated-h-2"><span><span class="text-main-1">other </span><?PHP echo $row['typee']; ?>s</span></h3>
            <div class="nk-gap"></div>
            <div class="row vertical-gap">
                <?PHP   $typee2=$row['typee']; 
                        $namee2=$row['namee']; 

                            $sql="SELECT * from event where typee='$typee2' and namee!='$namee2'";
                            $req = $db->prepare($sql);
                            $req->execute();
                            $liste = $req->fetchAll();
                            if ($req->execute())
                                ...
                                { ?>
                                    <div class="col-md-6">
                                        <div class="nk-product-cat">
                                            <a class="nk-product-image" href="store-product.php?id_game=<?PHP echo $row['id_event']; ?>">
                                            <img src="admin/pics/<?PHP echo $row['pic'] ?>" width="80" height="100"> 
                                            </a>
                                            <div class="nk-product-cont">
                                                <h3 class="nk-product-title h5"><a href="store-product.php?id_event=<?PHP echo $row['id_event']; ?>"><?PHP echo $row['namee']; ?></a></h3>
                                                <div class="nk-gap-1"></div>
