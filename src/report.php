...
<head>
    ...
    <title>GameEmpire | Elements</title>
        ...
        <div class="container">
            <div class="nk-nav-table">
                ...
                <a href="index.html" class="nk-nav-logo">
                    <img src="assets/images/logo.svg" alt="GameEmpire" width="199">
                </a>
...
<!-- END: Breadcrumbs -->
    ...
    <div class="container">
        <div class="row vertical-gap">
            ...
            <div class="col-lg-8">
                <!-- START: Paragraphs -->
                <h3 class="text-main-1">Signal a Problem</h3>
                <div class="nk-gap"></div>
                <p><strong>Report</strong> - You have any problem with your purshases,loging in or anything else please feel free to report the problem </p>
                    ...
                    <div class="nk-widget-content">
                        <form action="https://html.nkdev.info/goodgames/php/ajax-contact-form.php" class="nk-form nk-form-ajax">
                            <div class="row vertical-gap sm-gap">
                                <div class="col-md-6">
                                    <input type="text" class="form-control required" name="topic" placeholder="Topic *">
                                </div>
                                <div class="col-md-6">
                                    <input type="datetime" class="form-control required" name="name" placeholder="Date *">
                                </div>
                            </div>
                            <div class="nk-gap"></div>
