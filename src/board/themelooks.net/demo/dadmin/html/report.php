...
<html dir="ltr" lang="en" class="no-outlines">
    <!-- Mirrored from themelooks.net/demo/dadmin/html/Keys.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Apr 2020 19:05:37 GMT -->
    <head>
        <meta charset="UTF-8" />
        ...
        <div class="wrapper">
            <header class="navbar navbar-fixed">
                <div class="navbar--header">
                    <a href="Keys.html" class="logo"> <img src="assets/img/logo.png" alt="" /> </a> <a href="#" class="navbar--btn" data-toggle="sidebar" title="Toggle Sidebar"> <i class="fa fa-bars"></i> </a>
                </div>
                ...
                <div class="navbar--search">
                    <form action="http://themelooks.net/demo/dadmin/html/search-results.html">
                        <input type="search" name="search" class="form-control" placeholder="Search Something..." required /> <button class="btn-link"><i class="fa fa-search"></i></button>
                    </form>
                </div>
                            ...
                            <ul>
                                ...
                                <li class="active open">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="Keys.html">Keys</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
            ...
            <main class="main--container">
                <section class="page--header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <h2 class="page--title h5">Keys</h2>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="ecommerce.html">Ecommerce</a></li>
                                    <li class="breadcrumb-item active"><span>Keys</span></li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <div class="summary--widget">
                    ...
                    <div class="panel">
                        <div class="records--header">
                            <div class="title fa-shopping-bag">
                                <h3 class="h3">Ecommerce Keys <a href="#" class="btn btn-sm btn-outline-info">Manage Keys</a></h3>
                                <p>Found Total 1,330 Keys</p>
                            </div>
                            <div class="actions">
                                <form action="#" class="search">
                                    <input type="text" class="form-control" placeholder="Order ID or Customer Name..." required /> <button type="submit" class="btn btn-rounded"><i class="fa fa-search"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        <div class="records--list" data-title="Keys Listing">
                            <table id="recordsListView">
                                ...
                                <tbody>
                                    <?php include("core/retriverep.php");?>
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    <!-- Mirrored from themelooks.net/demo/dadmin/html/Keys.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Apr 2020 19:06:52 GMT -->
</html>
